(ns finagle-clojure.http2.integration-test
  ...
  (:require [midje.sweet :refer :all]
            ...
            [finagle-clojure.http2.client :as http-client]
            [finagle-clojure.http2.server :as http-server]
            [finagle-clojure.http2.message :as m]
